 ...
 */e7("firebase","11.4.0","app");const sc=sh(e9({apiKey:"AIzaSyBqoATuWSOg3ZDbSBOsvLiww1xc5xLSxak",authDomain:"desafio-ppt-e6f00.firebaseapp.com",databaseURL:"https://desafio-ppt-e6f00-default-rtdb.firebaseio.com",projectId:"desafio-ppt-e6f00",storageBucket:"desafio-ppt-e6f00.firebasestorage.app",messagingSenderId:"1005620596792",appId:"1:1005620596792:web:186bd21929786d9e1f16cd",measurementId:"G-QYCNTVFR3L"})),su={player1Name:null,player2Name:null,roomId:"",currentGame:null,playerNumber:void 0,id:null,rtdbRoomId:"",setCurrentGame:e=>{su.currentGame=e},player1Id:null,player2Id:null},sd=[],sp={getState:()=>(su.currentGame||(su.currentGame={roomId:su.roomId||"",data:{player1Name:null,player2Name:null,player1Play:null,player2Play:null,gameOver:!1},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}),su),setState(e){let t={...su,...e};for(let e of(Object.assign(su,t),sd))e(su);console.log("State actualizado:",su)},subscribe:e=>(sd.push(e),()=>{let t=sd.indexOf(e);-1!==t&&sd.splice(t,1)}),async getRoomData(e){try{console.log("getRoomData buscando roomId:",e);let t=st(sc,`rooms/${e}/games/current`),n=(await si(t)).val();if(n)return n;return console.error("state.ts:85 No se encontraron datos de la sala (games/current)."),null}catch(e){return console.error("Error al obtener datos de la sala:",e),null}},listenRoom(){if(console.log("Valor de state.roomId al inicio de listenRoom:",su.roomId,typeof su.roomId),!su.roomId){console.error("No hay roomId para escuchar.");return}so(st(sc,`rooms/${su.roomId}/games/current`),e=>{let t=e.val();if(console.log("Datos recibidos de la base de datos (games/current):",t),t){let e=su.player1Name,n=su.player2Name;sp.setState({...su,currentGame:{roomId:su.roomId,data:{player1Name:e,player2Name:n,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver},statistics:su.currentGame?.statistics||{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}}),console.log("Estado del juego actualizado:",su.currentGame)}else console.error("Datos de la partida actual incompletos o nulos en games/current:",t)},e=>{console.error("Error al escuchar la sala (games/current):",e)}),so(st(sc,`rooms/${su.roomId}/users`),e=>{let t=e.val();if(t){let e=Object.values(t),n=[];if(e.forEach(e=>{"object"==typeof e&&null!==e&&"userName"in e&&"role"in e&&"id"in e?n.push({userName:e.userName,role:e.role,id:e.id}):console.warn("Datos de usuario con estructura inesperada:",e)}),1===n.length){let e=n[0];sp.setPlayer1Name(e.userName,e.id),sp.setPlayer2Name(null,null),sp.setPlayerNumber(su.id===e.id?1:void 0)}else if(2===n.length){let e=n.find(e=>"owner"===e.role),t=n.find(e=>"guest"===e.role);e&&t&&(sp.setPlayer1Name(e.userName,e.id),sp.setPlayer2Name(t.userName,t.id),sp.setPlayerNumber(su.id===e.id?1:su.id===t.id?2:void 0))}else sp.setPlayer1Name(null,null),sp.setPlayer2Name(null,null),sp.setPlayerNumber(void 0);console.log("Estado actualizado con users:",su)}else console.log("No hay usuarios en la sala."),sp.setPlayer1Name(null,null),sp.setPlayer2Name(null,null),sp.setPlayerNumber(void 0)})},async setMove(e){let t=sp.getState(),n=t.roomId,i=t.playerNumber;if(!n){console.error("No se encontró el roomId");return}try{let t=st(sc,`rooms/${n}/games/current`);await function(e,t){rD("update",t,e._path,!1);let n=new er;return function(e,t,n,i){rY(e,"update",{path:t.toString(),value:n});let r=!0,s=rH(e),o={};if(tU(n,(n,i)=>{r=!1,o[n]=rg(np(t,n),nB(i),e.serverSyncTree_,s)}),r)tT("update() called with empty data.  Don't do anything."),rK(e,i,"ok",void 0);else{let r=rV(e),s=function(e,t,n,i){var r;r=e.pendingWriteTree_,H(i>r.lastWriteId,"Stacking an older merge on top of newer ones"),r.allWrites.push({path:t,children:n,writeId:i,visible:!0}),r.visibleWrites=ib(r.visibleWrites,t,n),r.lastWriteId=i;let s=ig.fromObject(n);return rr(e,new io(n7(),t,s))}(e.serverSyncTree_,t,o,r);rF(e.eventQueue_,s),e.server_.merge(t.toString(),n,(n,s)=>{let o="ok"===n;o||tN("update at "+t+" failed: "+n);let a=i9(e.serverSyncTree_,r,!o),l=a.length>0?rJ(e,t):t;rj(e.eventQueue_,l,a),rK(e,i,n,s)}),tU(n,n=>{let i=r1(e,np(t,n));rJ(e,i)}),rj(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback(()=>{})),n.promise}(t,1===i?{player1Move:e}:{player2Move:e}),console.log("Movimiento enviado con éxito")}catch(e){console.error("Error al enviar el movimiento:",e)}},setId:e=>{sp.setState({id:e})},setPlayer1Name:(e,t)=>{sp.setState({player1Name:e,player1Id:t})},setPlayer2Name:(e,t)=>{sp.setState({player2Name:e,player2Id:t})},setPlayerNumber:e=>{sp.setState({playerNumber:e})},setRoomId:e=>{sp.setState({roomId:e})},saveRoomData:async(e,t,n,i,r)=>{try{let s=await fetch("https://ppt-backend-1.onrender.com/api/guardardatos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({ownerId:e,ownerName:t,guestId:n,guestName:i,roomId:r})});if(!s.ok)return console.error("Error al guardar datos en el backend:",s.status),null;return await s.json()}catch(e){return console.error("Error de red al guardar datos:",e),null}}};class sf extends HTMLElement{constructor(){super(),this.unsubscribe=null,this.roomId=null,this.loading=!0,this.shadow=this.attachShadow({mode:"open"})}async connectedCallback(){try{let e=sp.getState().currentGame?.roomId;if(console.log("ShortId connectedCallback - roomId from state:",e),!e){if(console.warn("ShortId connectedCallback - roomId no encontrado en el estado. Intentando obtenerlo del URL..."),e=window.location.pathname.split("/")[2],console.log("ShortId connectedCallback - roomId from URL (window.location):",e),e)sp.setRoomId(e);else{console.error("ShortId connectedCallback - No se pudo obtener roomId."),this.loading=!1,this.render();return}}if(su.roomId){let e=await this.getRoomData(su.roomId);console.log("ShortId connectedCallback - roomData:",e);let t={roomId:su.roomId,data:e||{player1Name:null,player2Name:null},statistics:e?.statistics||{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}};sp.setState({currentGame:{...sp.getState().currentGame,...t}})}else{console.error("ShortId connectedCallback - state.roomId no está definido antes de getRoomData."),this.loading=!1,this.render();return}this.loading=!1,this.render(),this.listenRoomChanges()}catch(e){console.error("ShortId connectedCallback - Error:",e),this.loading=!1,this.render()}}async getRoomData(e){if(!e)return console.error("ShortId getRoomData - No se proporcionó roomId."),null;let t=st(sc,`rooms/${e}`);try{let e=(await si(t)).val();return console.log("ShortId getRoomData - Datos obtenidos:",e),e}catch(e){return console.error("ShortId getRoomData - Error al obtener datos:",e),null}}disconnectedCallback(){this.unsubscribeFromState(),this.stopListeningRoomChanges()}listenRoomChanges(){if(!su.roomId){console.error("ShortId listenRoomChanges - No hay roomId para escuchar.");return}so(st(sc,`rooms/${su.roomId}`),e=>{let t=e.val();if(console.log("ShortId listenRoomChanges - Datos recibidos de la base de datos:",t),t&&t.users){let e=Object.values(t.users);if(1===e.length){let n=e[0];sp.setPlayer1Name(n.userName,n.id),sp.setPlayer2Name(null,n.id),sp.setState({...su,currentGame:{...su.currentGame,roomId:su.roomId,data:{...su.currentGame?.data,player1Name:n.userName,player2Name:null,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver}}})}else if(2===e.length){let n=e[0],i=e[1];sp.setPlayer1Name(n.userName,n.id),sp.setPlayer2Name(i.userName,i.id),sp.setState({...su,currentGame:{...su.currentGame,roomId:su.roomId,data:{...su.currentGame?.data,player1Name:n.userName,player2Name:i.userName,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver}}})}console.log("ShortId listenRoomChanges - Estado actualizado con users:",su),this.render()}else console.warn("ShortId listenRoomChanges - Datos de sala incompletos o nulos:",t)},e=>{console.error("ShortId listenRoomChanges - Error al escuchar la sala:",e)})}stopListeningRoomChanges(){this.roomId}subscribeToState(){this.unsubscribe=sp.subscribe(()=>{this.render()})}unsubscribeFromState(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null)}render(){let e=sp.getState(),t=e.currentGame,n="Esperando Jugador 1",i="Esperando Jugador 2",r=e.player1Name,s=e.player2Name||"Esperando Jugador 2",o=e.roomId;t&&t.data&&(n=t.data.player1Name||"Esperando Jugador 1",i=t.data.player2Name||"Esperando Jugador 2"),this.shadow.innerHTML=`
    ...
    `,this.appendChild(e),this.addEventListeners()}addEventListeners(){let e=this.querySelector(".new-game-button"),t=this.querySelector(".join-room-button");e&&e.addEventListener("click",()=>{sP.goTo("/tu-nombre")}),t&&t.addEventListener("click",()=>{sP.goTo("/ingresar-a-sala")})}}customElements.define("welcome-page",sS);class sk extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.textContent=`
            .join-room-container {
                background-image: url(${_(k)});
                background-size: cover;
                background-repeat: no-repeat;
