 ...
 */e7("firebase","11.4.0","app");const sg=sm(e9({apiKey:"AIzaSyBqoATuWSOg3ZDbSBOsvLiww1xc5xLSxak",authDomain:"desafio-ppt-e6f00.firebaseapp.com",databaseURL:"https://desafio-ppt-e6f00-default-rtdb.firebaseio.com",projectId:"desafio-ppt-e6f00",storageBucket:"desafio-ppt-e6f00.firebasestorage.app",messagingSenderId:"1005620596792",appId:"1:1005620596792:web:186bd21929786d9e1f16cd",measurementId:"G-QYCNTVFR3L"})),sy={player1Name:"",player2Name:null,roomId:"",currentGame:null,playerNumber:1,id:null,rtdbRoomId:"",setCurrentGame:e=>{sy.currentGame=e}},sv=[],sb={getState:()=>(sy.currentGame||(sy.currentGame={roomId:sy.roomId,data:{player1Name:"",player2Name:"",player1Play:null,player2Play:null,gameOver:!1},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}),sy),setState(e){let t={...sy,...e};for(let e of(Object.assign(sy,t),sv))e(sy);console.log("State actualizado:",sy)},subscribe:e=>(sv.push(e),()=>{let t=sv.indexOf(e);-1!==t&&sv.splice(t,1)}),async getRoomData(e){try{console.log("getRoomData buscando roomId:",e);let t=sl(sg,`rooms/${e}`),n=(await function(e){e=eT(e);let t=new su(new sr(()=>{}));return(function(e,t,n){let i=function(e,t){var n;let i=t._path,r=null;e.syncPointTree_.foreachOnPath(i,(e,t)=>{let n=n_(e,i);r=r||i2(t,n)});let s=e.syncPointTree_.get(i);s?r=r||i2(s,no()):(s=new iX,e.syncPointTree_=e.syncPointTree_.set(i,s));let o=null!=r,a=o?new ia(r,!0,!1):null,l=(n=e.pendingWriteTree_,iF(t._path,n));return ip(i0(s,t,l,o?a.getNode():nH.EMPTY_NODE,o).viewCache_)}(e.serverSyncTree_,t);return null!=i?Promise.resolve(i):e.server_.get(t).then(i=>{let r;let s=nB(i).withIndex(t._queryParams.getIndex());if(ri(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())r=re(e.serverSyncTree_,t._path,s);else{let n=ra(e.serverSyncTree_,t);r=rn(e.serverSyncTree_,t._path,s,n)}return rW(e.eventQueue_,t._path,r),rt(e.serverSyncTree_,t,n,null,!0),s},n=>(rZ(e,"get for query "+eu(t)+" failed: "+n),Promise.reject(Error(n))))})(e._repo,e,t).then(t=>new sa(t,new so(e._repo,e._path),e._queryParams.getIndex()))}(t)).val();if(n)return n;return console.error("state.ts:85 No se encontraron datos de la sala."),null}catch(e){return console.error("Error al obtener datos de la sala:",e),null}},listenRoom(){if(!sy.roomId){console.error("No hay roomId para escuchar.");return}sp(sl(sg,`rooms/${sy.roomId}`),e=>{let t=e.val();if(console.log("Datos recibidos de la base de datos:",t),t&&t.users){let e=Object.values(t.users);if(1===e.length){let n=e[0];this.setPlayer1Name(n.userName),this.setPlayer2Name(null),this.setState({...sy,currentGame:{roomId:sy.roomId,data:{player1Name:n.userName,player2Name:null,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}})}else if(2===e.length){let n=e[0],i=e[1];this.setPlayer1Name(n.userName),this.setPlayer2Name(i.userName),this.setState({...sy,currentGame:{roomId:sy.roomId,data:{player1Name:n.userName,player2Name:i.userName,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}})}console.log("Estado actualizado con users:",sy)}else console.error("state.ts:148 Datos de sala incompletos o nulos:",t)},e=>{console.error("Error al escuchar la sala:",e)})},setPlayer1Name(e){this.setState({player1Name:e})},setPlayer2Name(e){this.setState({player2Name:e})},setRoomId(e){this.setState({roomId:e})},setId(e){this.setState({id:e})},async createUser(e){let t=function(e,t){let n;rq("push",(e=eT(e))._path),rD("push",void 0,e._path,!0);let i=st(rV(e._repo)),r=sh(e,i),s=sh(e,i);return r.then=(n=Promise.resolve(s)).then.bind(n),r.catch=n.then.bind(n,void 0),r}(sl(sg,"users"));return await sc(t,{nombre:e}),t.key},async saveRoomData(e,t,n,i,r){try{let s=await fetch("https://ppt-backend-1.onrender.com/api/guardardatos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({ownerId:e,ownerName:t,guestId:n,guestName:i,roomId:r})});if(!s.ok)throw Error(`HTTP error! status: ${s.status}`);return(await s.json()).roomId}catch(e){console.error("Error al guardar datos de la sala:",e);return}},async setMove(e){let t=sb.getState(),n=t.roomId,i=t.playerNumber;if(!n){console.error("No se encontró el roomId");return}try{let t=sl(sg,`games/${n}`);await sc(t,1===i?{player1Move:e}:{player2Move:e}),console.log("Movimiento enviado con éxito")}catch(e){console.error("Error al enviar el movimiento:",e)}}};class sC extends HTMLElement{constructor(){super(),this.unsubscribe=null,this.roomId=null,this.loading=!0,this.shadow=this.attachShadow({mode:"open"})}async connectedCallback(){if(this.roomId=sb.getState().roomId,this.roomId){try{let e=await sb.getRoomData(this.roomId);e?sb.setState({...sb.getState(),currentGame:{...sb.getState().currentGame,data:e,statistics:e.statistics}}):console.error("short-id.ts:33 No se encontraron datos de la sala.")}catch(e){console.error("Error al obtener datos de la sala:",e)}this.listenRoomChanges(this.roomId)}this.loading=!1,this.render(),this.subscribeToState()}disconnectedCallback(){this.unsubscribeFromState(),this.stopListeningRoomChanges()}listenRoomChanges(e){sp(sl(sg,`rooms/${e}/users`),e=>{let t=e.val();if(t){let e=Object.values(t);if(1===e.length){let t=e[0];sb.setState({...sb.getState(),player1Name:t.userName,player2Name:null,currentGame:{data:{player1Name:t.userName,player2Name:null,player1Play:null,player2Play:null,gameOver:!1},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}})}else if(2===e.length){let t=e[0],n=e[1];sb.setState({...sb.getState(),player1Name:t.userName,player2Name:n.userName,currentGame:{data:{player1Name:t.userName,player2Name:n.userName,player1Play:null,player2Play:null,gameOver:!1},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}})}this.render()}else console.error("short-id.ts:64 Error: datos de la sala no válidos.")})}stopListeningRoomChanges(){this.roomId&&sp(sl(sg,`rooms/${this.roomId}/currentGame/data`),()=>{})}subscribeToState(){this.unsubscribe=sb.subscribe(()=>{this.render()})}unsubscribeFromState(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null)}render(){let e=sb.getState(),t=e.currentGame,n="Esperando Jugador 1",i="Esperando Jugador 2",r=e.player1Name,s=e.player2Name||"Esperando Jugador 2";if(t&&t.data&&(n=t.data.player1Name||"Esperando Jugador 1",i=t.data.player2Name||"Esperando Jugador 2"),this.loading)this.shadow.innerHTML=`
    ...
    `,this.appendChild(e),this.addEventListeners()}addEventListeners(){let e=this.querySelector(".new-game-button"),t=this.querySelector(".join-room-button");e&&e.addEventListener("click",()=>{sF.goTo("/tu-nombre")}),t&&t.addEventListener("click",()=>{sF.goTo("/ingresar-a-sala")})}}customElements.define("welcome-page",sA);class sO extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}render(){this.innerHTML=`
      <div class="join-room-container">
        <h1>Ingresar a una Sala</h1>
        <input type="text" id="roomIdInput" placeholder="Room ID">
        <input type="text" id="nombreInput" placeholder="Tu nombre">
        <input type="hidden" id="guestIdInput" value="${sP()}">
        <button id="unirseButton">Unirse</button>
      </div>
    `;let e=this.querySelector("#roomIdInput"),t=this.querySelector("#nombreInput"),n=this.querySelector("#guestIdInput"),i=this.querySelector("#unirseButton");i&&e&&t&&n&&i.addEventListener("click",async()=>{let i=e.value.trim(),r=t.value.trim(),s=n.value;if(i&&r)try{sb.setId(s),sb.setPlayer2Name(r),sb.setRoomId(i),await sb.saveRoomData(null,null,s,r,i),setTimeout(()=>{sb.listenRoom(),sF.goTo(`/short-id/${i}`)},100)}catch(e){console.error("Error al unirse a la sala:",e)}});let r=document.createElement("style");r.textContent=`
      .join-room-container {
        background-image: url(${_(k)});
        background-size: cover;
        background-repeat: no-repeat;
