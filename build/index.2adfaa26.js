let e,t,n,i,r,s,o,a,l,h,c,u,d,p,f;function _(e){return e&&e.__esModule?e.default:e}var m,g,y,v,b,C,w,I=globalThis,E={},T={},S=I.parcelRequire94c2;null==S&&((S=function(e){if(e in E)return E[e].exports;if(e in T){var t=T[e];delete T[e];var n={id:e,exports:{}};return E[e]=n,t.call(n.exports,n,n.exports),n.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){T[e]=t},I.parcelRequire94c2=S),(0,S.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>n,set:e=>n=e,enumerable:!0,configurable:!0});var n,i=new Map;n=function(e,t){for(var n=0;n<t.length-1;n+=2)i.set(t[n],{baseUrl:e,path:t[n+1]})}}),S("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["aD2KL","index.2adfaa26.js","fEBQw","piedrapapelotijera.a2838792.jpg","52iaa","piedra.2b6b2e59.png","5ZWGO","tijera.4b8c96df.png","CLWUy","papel.7c3d639f.png"]'));var x={};x=new URL("piedrapapelotijera.a2838792.jpg",import.meta.url).toString();const k=()=>void 0;var N={},P=N={};function R(){throw Error("setTimeout has not been defined")}function D(){throw Error("clearTimeout has not been defined")}function A(e){if(y===setTimeout)return setTimeout(e,0);if((y===R||!y)&&setTimeout)return y=setTimeout,setTimeout(e,0);try{return y(e,0)}catch(t){try{return y.call(null,e,0)}catch(t){return y.call(this,e,0)}}}!function(){try{y="function"==typeof setTimeout?setTimeout:R}catch(e){y=R}try{v="function"==typeof clearTimeout?clearTimeout:D}catch(e){v=D}}();var M=[],O=!1,L=-1;function F(){O&&b&&(O=!1,b.length?M=b.concat(M):L=-1,M.length&&q())}function q(){if(!O){var e=A(F);O=!0;for(var t=M.length;t;){for(b=M,M=[];++L<t;)b&&b[L].run();L=-1,t=M.length}b=null,O=!1,function(e){if(v===clearTimeout)return clearTimeout(e);if((v===D||!v)&&clearTimeout)return v=clearTimeout,clearTimeout(e);try{v(e)}catch(t){try{return v.call(null,e)}catch(t){return v.call(this,e)}}}(e)}}function j(e,t){this.fun=e,this.array=t}function U(){}P.nextTick=function(e){var t=Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)t[n-1]=arguments[n];M.push(new j(e,t)),1!==M.length||O||A(q)},j.prototype.run=function(){this.fun.apply(null,this.array)},P.title="browser",P.browser=!0,P.env={},P.argv=[],P.version="",P.versions={},P.on=U,P.addListener=U,P.once=U,P.off=U,P.removeListener=U,P.removeAllListeners=U,P.emit=U,P.prependListener=U,P.prependOnceListener=U,P.listeners=function(e){return[]},P.binding=function(e){throw Error("process.binding is not supported")},P.cwd=function(){return"/"},P.chdir=function(e){throw Error("process.chdir is not supported")},P.umask=function(){return 0};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n8{constructor(e){this.collection_=e,this.last_=null}get(){let e=this.collection_.get(),t=Object.assign({},e);return this.last_&&tU(this.last_,(e,n)=>{t[e]=t[e]-n}),this.last_=e,t}}class n7{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new n8(e);let n=1e4+2e4*Math.random();tz(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){let e=this.statsListener_.get(),t={},n=!1;tU(e,(e,i)=>{i>0&&e_(this.statsToReport_,e)&&(t[e]=i,n=!0)}),n&&this.server_.reportStats(t),tz(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}function n9(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function ie(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function it(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}(g=w||(w={}))[g.OVERWRITE=0]="OVERWRITE",g[g.MERGE=1]="MERGE",g[g.ACK_USER_WRITE=2]="ACK_USER_WRITE",g[g.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */e9("firebase","11.4.0","app");const sy=sg(e7({apiKey:"AIzaSyBqoATuWSOg3ZDbSBOsvLiww1xc5xLSxak",authDomain:"desafio-ppt-e6f00.firebaseapp.com",databaseURL:"https://desafio-ppt-e6f00-default-rtdb.firebaseio.com",projectId:"desafio-ppt-e6f00",storageBucket:"desafio-ppt-e6f00.firebasestorage.app",messagingSenderId:"1005620596792",appId:"1:1005620596792:web:186bd21929786d9e1f16cd",measurementId:"G-QYCNTVFR3L"})),sv={player1Name:"",player2Name:null,roomId:"",currentGame:null,playerNumber:1,id:null,rtdbRoomId:"",setCurrentGame:e=>{sv.currentGame=e}},sb=[],sC={getState:()=>(sv.currentGame||(sv.currentGame={roomId:sv.roomId||"",data:{player1Name:"",player2Name:"",player1Play:null,player2Play:null,gameOver:!1},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}),sv),setState(e){let t={...sv,...e};for(let e of(Object.assign(sv,t),sb))e(sv);console.log("State actualizado:",sv)},subscribe:e=>(sb.push(e),()=>{let t=sb.indexOf(e);-1!==t&&sb.splice(t,1)}),async getRoomData(e){try{console.log("getRoomData buscando roomId:",e);let t=sl(sy,`games/${e}`),n=(await su(t)).val();if(n)return n;return console.error("state.ts:85 No se encontraron datos de la sala."),null}catch(e){return console.error("Error al obtener datos de la sala:",e),null}},listenRoom(){if(!sv.roomId){console.error("No hay roomId para escuchar.");return}sf(sl(sy,`games/${sv.roomId}`),e=>{let t=e.val();if(console.log("Datos recibidos de la base de datos:",t),t&&t.users){let e=Object.values(t.users);if(1===e.length){let n=e[0];sC.setPlayer1Name(n.userName,n.id),sC.setPlayer2Name(null,n.id),sC.setState({...sv,playerNumber:sv.id===n.id?1:void 0,currentGame:{roomId:sv.roomId,data:{player1Name:n.userName,player2Name:null,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}})}else if(2===e.length){let n=e[0],i=e[1],r=1;sv.id===i.id&&(r=2),sC.setPlayer1Name(n.userName,n.id),sC.setPlayer2Name(i.userName,i.id),sC.setState({...sv,playerNumber:r,currentGame:{roomId:sv.roomId,data:{player1Name:n.userName,player2Name:i.userName,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}})}console.log("Estado actualizado con users:",sv)}else console.error("Datos de sala incompletos o nulos:",t)},e=>{console.error("Error al escuchar la sala:",e)})},setPlayer1Name(e,t){let n=this.determinePlayerNumber(t);this.setState({player1Name:e,playerNumber:n})},setPlayer2Name(e,t){let n=this.determinePlayerNumber(t);this.setState({player2Name:e,playerNumber:n})},determinePlayerNumber:e=>e===sv.id?2:1,setRoomId(e){this.setState({roomId:e})},setId(e){this.setState({id:e})},async createUser(e){let t=function(e,t){let n;rq("push",(e=eT(e))._path),rD("push",void 0,e._path,!0);let i=st(rV(e._repo)),r=sh(e,i),s=sh(e,i);return r.then=(n=Promise.resolve(s)).then.bind(n),r.catch=n.then.bind(n,void 0),r}(sl(sy,"users"));return await sc(t,{nombre:e}),t.key},async saveRoomData(e,t,n,i,r){try{let s=await fetch("https://ppt-backend-1.onrender.com/api/guardardatos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({ownerId:e,ownerName:t,guestId:n,guestName:i,roomId:r})});if(!s.ok)throw Error(`HTTP error! status: ${s.status}`);return(await s.json()).roomId}catch(e){console.error("Error al guardar datos de la sala:",e);return}},async setMove(e){let t=sC.getState(),n=t.roomId,i=t.playerNumber;if(!n){console.error("No se encontró el roomId");return}try{let t=sl(sy,`games/${n}`);await sc(t,1===i?{player1Move:e}:{player2Move:e}),console.log("Movimiento enviado con éxito")}catch(e){console.error("Error al enviar el movimiento:",e)}}};class sw extends HTMLElement{constructor(){super(),this.unsubscribe=null,this.roomId=null,this.loading=!0,this.shadow=this.attachShadow({mode:"open"})}async connectedCallback(){try{let e=sC.getState().currentGame?.roomId;if(console.log("ShortId connectedCallback - roomId from state:",e),!e){if(console.warn("ShortId connectedCallback - roomId no encontrado en el estado. Intentando obtenerlo del URL..."),e=window.location.pathname.split("/")[2],console.log("ShortId connectedCallback - roomId from URL (window.location):",e),e)sC.setRoomId(e);else{console.error("ShortId connectedCallback - No se pudo obtener roomId."),this.loading=!1,this.render();return}}if(sv.roomId){let e=await this.getRoomData(sv.roomId);console.log("ShortId connectedCallback - roomData:",e);let t={roomId:sv.roomId,data:e||{player1Name:null,player2Name:null},statistics:e?.statistics||{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}};sC.setState({currentGame:{...sC.getState().currentGame,...t}})}else{console.error("ShortId connectedCallback - state.roomId no está definido antes de getRoomData."),this.loading=!1,this.render();return}this.loading=!1,this.render(),this.listenRoomChanges()}catch(e){console.error("ShortId connectedCallback - Error:",e),this.loading=!1,this.render()}}async getRoomData(e){if(!e)return console.error("ShortId getRoomData - No se proporcionó roomId."),null;let t=sl(sy,`rooms/${e}`);try{let e=(await su(t)).val();return console.log("ShortId getRoomData - Datos obtenidos:",e),e}catch(e){return console.error("ShortId getRoomData - Error al obtener datos:",e),null}}disconnectedCallback(){this.unsubscribeFromState(),this.stopListeningRoomChanges()}listenRoomChanges(){if(!sv.roomId){console.error("ShortId listenRoomChanges - No hay roomId para escuchar.");return}sf(sl(sy,`rooms/${sv.roomId}`),e=>{let t=e.val();if(console.log("ShortId listenRoomChanges - Datos recibidos de la base de datos:",t),t&&t.users){let e=Object.values(t.users);if(1===e.length){let n=e[0];sC.setPlayer1Name(n.userName,n.id),sC.setPlayer2Name(null,n.id),sC.setState({...sv,currentGame:{...sv.currentGame,roomId:sv.roomId,data:{...sv.currentGame?.data,player1Name:n.userName,player2Name:null,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver}}})}else if(2===e.length){let n=e[0],i=e[1];sC.setPlayer1Name(n.userName,n.id),sC.setPlayer2Name(i.userName,i.id),sC.setState({...sv,currentGame:{...sv.currentGame,roomId:sv.roomId,data:{...sv.currentGame?.data,player1Name:n.userName,player2Name:i.userName,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver}}})}console.log("ShortId listenRoomChanges - Estado actualizado con users:",sv),this.render()}else console.warn("ShortId listenRoomChanges - Datos de sala incompletos o nulos:",t)},e=>{console.error("ShortId listenRoomChanges - Error al escuchar la sala:",e)})}stopListeningRoomChanges(){this.roomId}subscribeToState(){this.unsubscribe=sC.subscribe(()=>{this.render()})}unsubscribeFromState(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null)}render(){let e=sC.getState(),t=e.currentGame,n="Esperando Jugador 1",i="Esperando Jugador 2",r=e.player1Name,s=e.player2Name||"Esperando Jugador 2",o=e.roomId;t&&t.data&&(n=t.data.player1Name||"Esperando Jugador 1",i=t.data.player2Name||"Esperando Jugador 2"),this.shadow.innerHTML=`
            <style>
                .container {
        ...
        `;let a=this.shadow.getElementById("instructions-button");a&&a.addEventListener("click",()=>{sq.goTo("/instructions")})}determinePlayerNumber(e){return 1}}customElements.define("short-id-page",sw);class sI extends HTMLElement{constructor(){super(),this.unsubscribe=null,this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.subscribeToState()}disconnectedCallback(){this.unsubscribeFromState()}subscribeToState(){this.unsubscribe=sC.subscribe(()=>{this.render()})}unsubscribeFromState(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null)}render(){let e=sC.getState();this.shadow.innerHTML=`
      <style>
        .container {
          background-image: url(${_(x)});
          background-size: cover;
    ...
    `;let t=this.shadow.querySelector(".play-button");t&&t.addEventListener("click",()=>{sq.goTo("/play")})}}customElements.define("instructions-page",sI);var sE={};sE=new URL("piedra.2b6b2e59.png",import.meta.url).toString();var sT={};sT=new URL("tijera.4b8c96df.png",import.meta.url).toString();var sS={};sS=new URL("papel.7c3d639f.png",import.meta.url).toString();class sx extends HTMLElement{constructor(){super(),this.roomId=null,this.playerNumber=1,this.unsubscribe=null,this.myMove=null,this.opponentMove=null,this.timerInterval=null,this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.subscribeToState()}disconnectedCallback(){this.unsubscribe&&this.unsubscribe()}subscribeToState(){this.unsubscribe=sC.subscribe(()=>{console.log("El estado ha cambiado, actualizando UI..."),this.updateUI()})}render(){let e=this.shadow;if(e){e.innerHTML=`
                <div class="play-container">
                    ...
                    <div class="moves">
                        <button id="piedra"><img src="${_(sE)}" alt="piedra"/></button>
                        <button id="papel"><img src="${_(sS)}" alt ="papel"/></button>
                        <button id="tijera"><img src="${_(sT)}" alt="Tijera"/></button>
                    </div>
                    <div>
            ...
            `,e.appendChild(o)}}async updateUI(){let e=sC.getState(),t=e.currentGame?.roomId;t&&sf(sl(sg(),`games/${t}`),e=>{let t=e.val();if(t){if(t.gameOver){let e=t.result,n=this.shadow?.querySelector("#tu-jugada"),i=this.shadow?.querySelector("#jugada-oponente"),r=this.shadow?.querySelector("#resultado");n&&(n.textContent=1===this.playerNumber?t.player1Move:t.player2Move),i&&(i.textContent=1===this.playerNumber?t.player2Move:t.player1Move),r&&(0===e?r.textContent="Empate":this.playerNumber===e?r.textContent="Ganaste":r.textContent="Perdiste")}else{let e=this.shadow?.querySelector("#tu-jugada"),n=this.shadow?.querySelector("#jugada-oponente");e&&(e.textContent=1===this.playerNumber?t.player1Move||"":t.player2Move||""),n&&(n.textContent=1===this.playerNumber?t.player2Move||"":t.player1Move||"")}}else console.error("No se encontraron datos de la partida.")},e=>{console.error("Error al obtener datos de la partida:",e)})}determineWinner(e,t){return e===t?0:"piedra"===e&&"tijera"===t||"papel"===e&&"piedra"===t||"tijera"===e&&"papel"===t?1:2}checkAndHideMoves(e){e&&(e.style.display="none")}animateMoves(e){let t=sC.getState().currentGame;if(t){let n=1===this.playerNumber?t.data.player2Move:t.data.player1Move;if(n){let t=this.shadow?.querySelector(`#${e} img`),i=this.shadow?.querySelector(`#${n} img`);if(t&&i){t.style.position="absolute",i.style.position="absolute";let e=t.getBoundingClientRect(),n=i.getBoundingClientRect();t.style.left=`${e.left}px`,t.style.top=`${e.top}px`,i.style.left=`${n.left}px`,i.style.top=`${n.top}px`;let r=this.shadow?.querySelector(".play-container")?.getBoundingClientRect();if(r){let s=r.left+r.width/2,o=r.top+r.height/2;t.style.transition="transform 0.5s ease-in-out",i.style.transition="transform 0.5s ease-in-out",requestAnimationFrame(()=>{t.style.transform=`translate(${s-e.left-e.width/2}px, ${o-e.top-e.height/2}px)`,i.style.transform=`translate(${s-n.left-n.width/2}px, ${o-n.top-n.height/2}px)`}),setTimeout(()=>{t.style.transition="none",i.style.transition="none",t.style.position="static",i.style.position="static",t.style.transform="none",i.style.transform="none"},500)}}}}}redirectToResultPage(){let e=sC.getState();if(e.currentGame&&e.currentGame.data){let t=e.currentGame.data;t.player1Move&&t.player2Move&&(window.location.href="/result")}}}customElements.define("play-page",sx);var sk={randomUUID:"undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto)};const sN=new Uint8Array(16),sP=[];for(let e=0;e<256;++e)sP.push((e+256).toString(16).slice(1));var sR=function(e,t,n){if(sk.randomUUID&&!t&&!e)return sk.randomUUID();let i=(e=e||{}).random??e.rng?.()??function(){if(!d){if("undefined"==typeof crypto||!crypto.getRandomValues)throw Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");d=crypto.getRandomValues.bind(crypto)}return d(sN)}();if(i.length<16)throw Error("Random bytes length must be >= 16");if(i[6]=15&i[6]|64,i[8]=63&i[8]|128,t){if((n=n||0)<0||n+16>t.length)throw RangeError(`UUID byte range ${n}:${n+15} is out of buffer bounds`);for(let e=0;e<16;++e)t[n+e]=i[e];return t}return function(e,t=0){return(sP[e[t+0]]+sP[e[t+1]]+sP[e[t+2]]+sP[e[t+3]]+"-"+sP[e[t+4]]+sP[e[t+5]]+"-"+sP[e[t+6]]+sP[e[t+7]]+"-"+sP[e[t+8]]+sP[e[t+9]]+"-"+sP[e[t+10]]+sP[e[t+11]]+sP[e[t+12]]+sP[e[t+13]]+sP[e[t+14]]+sP[e[t+15]]).toLowerCase()}(i)};class sD extends HTMLElement{constructor(){super()}connectedCallback(){this.render()}render(){this.innerHTML=`
      <div class="welcome-container">
        <h1>Ingresa tu Nombre</h1>
        <input type="text" id="nombreInput" placeholder="Tu nombre">
        <input type="hidden" id="ownerIdInput" value="${sR()}">
        <button id="comenzarButton">Comenzar</button>
      </div>
    `;let e=this.querySelector("#nombreInput"),t=this.querySelector("#ownerIdInput"),n=this.querySelector("#comenzarButton");n&&e&&t&&n.addEventListener("click",async()=>{let n=e.value.trim(),i=t.value;if(n)try{sC.setId(i),sC.setPlayer1Name(n,i);let e=await sC.saveRoomData(i,n);e?(sC.setRoomId(e),setTimeout(()=>{sC.listenRoom(),sq.goTo(`/short-id/${e}`)},100)):alert("Error al crear la sala. Inténtalo de nuevo.")}catch(e){console.error("Error al crear la sala:",e)}});let i=document.createElement("style");i.textContent=`
      .welcome-container {
        background-image: url(${_(x)});
        background-size: cover;
        background-repeat: no-repeat;
    ...
    `,this.appendChild(i)}}customElements.define("tu-nombre",sD);class sA extends HTMLElement{constructor(){super(),this.render()}render(){let e=sC.getState().currentGame;if(!e||!e.data){this.innerHTML=`
        ...
        `,this.appendChild(a)}}customElements.define("result-page",sA);class sM extends HTMLElement{constructor(){super(),this.render()}render(){this.innerHTML=`
      <div class="welcome-container">
    ...
    `,this.appendChild(e),this.addEventListeners()}addEventListeners(){let e=this.querySelector(".new-game-button"),t=this.querySelector(".join-room-button");e&&e.addEventListener("click",()=>{sq.goTo("/tu-nombre")}),t&&t.addEventListener("click",()=>{sq.goTo("/ingresar-a-sala")})}}customElements.define("welcome-page",sM);class sO extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.textContent=`
            .join-room-container {
                background-image: url(${_(x)});
                background-size: cover;
                background-repeat: no-repeat;
        ...
        `,this.shadow.appendChild(e);let t=document.createElement("div");t.classList.add("join-room-container");let n=document.createElement("h2");n.textContent="Ingresar a una Sala",t.appendChild(n);let i=document.createElement("div");i.classList.add("form-group");let r=document.createElement("input");r.setAttribute("type","text"),r.setAttribute("placeholder","Código para ingresar a la sala"),r.id="roomIdInput",i.appendChild(r),t.appendChild(i);let s=document.createElement("div");s.classList.add("form-group");let o=document.createElement("input");o.setAttribute("type","text"),o.setAttribute("placeholder","Tu nombre"),o.id="nombreInput",s.appendChild(o),t.appendChild(s);let a=document.createElement("button");a.textContent="Unirse a Sala",a.id="unirseButton",t.appendChild(a),this.shadow.appendChild(t);let l=this.shadow.getElementById("unirseButton"),h=this.shadow.getElementById("roomIdInput"),c=this.shadow.getElementById("nombreInput");l&&h&&c&&l.addEventListener("click",async()=>{let e=c.value,t=h.value,n=sv.id||Math.random().toString(36).substring(2,15);sC.setPlayer2Name(e,n),sC.setRoomId(t),await sC.saveRoomData(null,null,n,e,t),setTimeout(()=>{sC.listenRoom(),sq.goTo(`/short-id/${t}`)},100)})}render(){}}customElements.define("ingresar-a-sala",sO);const sL=[{pathRegex:/^\/$/,render:()=>new sM},{pathRegex:/^\/instructions$/,render:()=>new sI},{pathRegex:/^\/play$/,render:()=>new sx},{pathRegex:/^\/result$/,render:()=>new sA},{pathRegex:/^\/tu-nombre$/,render:()=>new sD},{pathRegex:/^\/short-id\/(?<roomId>[a-zA-Z0-9]+)$/,render:e=>(e?.roomId,new sw)},{pathRegex:/^\/ingresar-a-sala$/,render:()=>new sO}];function sF(e){let t=sL.find(t=>t.pathRegex.test(e));if(t){let n=document.getElementById("app");if(n){n.innerHTML="";let i=e.match(t.pathRegex),r=i?.groups||{},s=t.render(r);s instanceof Promise?s.then(e=>{n.appendChild(e)}).catch(e=>{console.error("Error al renderizar la ruta:",e)}):n.appendChild(s)}else console.warn("Elemento #app no encontrado.")}else console.warn(`Ruta no encontrada: ${e}`)}const sq={goTo:async e=>{window.history.pushState({},"",e),await sF(e)}};!function(){let e=function(){let e=window.location.pathname,t="/PPT-FRONTEND";return e.startsWith(t)?e.replace(t,"")||"/":e}();console.log("Ruta inicial:",e),sF(e)}();
//# sourceMappingURL=index.2adfaa26.js.map
