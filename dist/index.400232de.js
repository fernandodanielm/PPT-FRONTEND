function e(e){return e&&e.__esModule?e.default:e}var t=globalThis,o={},r={},n=t.parcelRequire94c2;null==n&&((n=function(e){if(e in o)return o[e].exports;if(e in r){var t=r[e];delete r[e];var n={id:e,exports:{}};return o[e]=n,t.call(n.exports,n,n.exports),n.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){r[e]=t},t.parcelRequire94c2=n),(0,n.register)("27Lyk",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>o,set:e=>o=e,enumerable:!0,configurable:!0});var o,r=new Map;o=function(e,t){for(var o=0;o<t.length-1;o+=2)r.set(t[o],{baseUrl:e,path:t[o+1]})}}),n("27Lyk").register(new URL("",import.meta.url).toString(),JSON.parse('["h2yyf","index.400232de.js","28hUx","piedrapapelotijera.a2838792.jpg","80kxP","piedra.2b6b2e59.png","bS7qZ","tijera.4b8c96df.png","eEgVe","papel.7c3d639f.png"]'));const a={currentGame:{data:{player1Name:"",player2Name:"",player1Play:null,player2Play:null,statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}},gameOver:!1,readyForNextRound:!1},shortId:null},listeners:[],getState(){return this},setState(e){for(let t of(this.currentGame=e.currentGame,this.listeners))t(e)},subscribe(e){this.listeners.push(e)},setPlayerName(e){let t=this.getState();t.name=e,this.setState(t)},async createRoom(){let e=await fetch("https://ppt-backend-three.vercel.app/api/rooms",{method:"POST"}),t=await e.json(),o=a.getState();return o.currentGame.shortId=t.roomId,a.setState(o),t.roomId},async joinRoom(e,t){let o=await fetch(`https://ppt-backend-three.vercel.app/api/rooms/${e}/join`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({playerName:t})});return(await o.json()).playerNumber},async setMove(e,t,o){await fetch(`https://ppt-backend-three.vercel.app/api/rooms/${e}/move`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({playerNumber:t,move:o})})},async resetGame(){let e=this.getState(),t=e.currentGame.shortId;if(t)try{let o=await fetch(`https://ppt-backend-three.vercel.app/api/rooms/${t}/reset`,{method:"PUT"});if(!o.ok)throw Error(`Error al reiniciar la sala: ${o.statusText}`);e.currentGame.data={player1Name:"",player2Name:"",player1Play:null,player2Play:null,statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}},gameOver:!1,readyForNextRound:!1},this.setState(e)}catch(e){console.error("Error al reiniciar la sala:",e),alert("Hubo un error al reiniciar la sala. Inténtalo de nuevo.")}}};var i={};i=new URL("piedrapapelotijera.a2838792.jpg",import.meta.url).toString();var s={};s=new URL("piedra.2b6b2e59.png",import.meta.url).toString();var l={};l=new URL("tijera.4b8c96df.png",import.meta.url).toString();var d={};d=new URL("papel.7c3d639f.png",import.meta.url).toString();class p extends HTMLElement{constructor(){super(),this.roomId=null,this.shadow=this.attachShadow({mode:"open"})}setRoomId(e){this.roomId=e}async connectedCallback(){let e=window.location.pathname.split("/");if(this.roomId=e[e.length-1]||null,console.log("ShortId: roomId recibido:",this.roomId),!this.roomId){console.error("ShortId: roomId no encontrado en la URL."),window.goTo("/");return}console.log("ShortId: roomId válido. Continuando con la renderización."),this.render()}render(){if(this.shadow){let t=a.getState(),o=this.roomId||t.currentGame.shortId,r=t.currentGame.data.player1Name;console.log("ShortId: Renderizando con roomId:",o),console.log("ShortId: Owner:",r),this.shadow.innerHTML=`
            ...
            `,this.shadow.appendChild(n)}}}customElements.define("short-id",p);class c extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){if(!a.getState().currentGame.shortId){window.goTo("/");return}this.render()}render(){if(this.shadow){this.shadow.innerHTML=`
            ...
            `,this.shadow.appendChild(o)}}}customElements.define("instructions-page",c);class m extends HTMLElement{constructor(){super(),this.roomId=null,this.playerNumber=1,this.shadow=this.attachShadow({mode:"open"})}async connectedCallback(){let e=a.getState();this.roomId=e.currentGame.shortId;let t=e.currentGame.data.player1Name,o=e.currentGame.data.player2Name;if(t&&(this.playerNumber=o?2:1),!this.roomId){window.goTo("/");return}this.render(),await this.waitForGameResult()}async waitForGameResult(){return new Promise(e=>{a.subscribe(async t=>{t.currentGame.data.gameOver&&(e(!0),window.goTo("/result"))})})}render(){let t=this.shadow;if(t){t.innerHTML=`
            ...
            `;let o=t.querySelector(".moves"),r=t.querySelector("#timer"),n=t.querySelector(".timer"),p=3;n.style.animation=`countdown ${p}s linear forwards`;let c=setInterval(()=>{p--,r&&(r.textContent=p.toString()),0===p&&(clearInterval(c),o&&(o.style.display="none"))},1e3);o?.addEventListener("click",async e=>{let o=e.target.closest("button");if(o){clearInterval(c),t.querySelectorAll(".moves button").forEach(e=>{let t=e.querySelector("img");e===o?t?.classList.add("selected"):t?.classList.add("unselected")});let e=o.id;this.roomId?await a.setMove(this.roomId,this.playerNumber,e):console.error("roomId es null. No se puede realizar el movimiento.")}});let m=document.createElement("style");m.textContent=`
                .play-container {
                    background-image: url(${e(i)});
                    background-size: cover;
                    height: 100vh;
        ...
        `,this.appendChild(o)}constructor(...e){super(...e),this.roomId=null}}customElements.define("tu-nombre",h);class u extends HTMLElement{constructor(){super(),this.roomId=null,this.shadow=this.attachShadow({mode:"open"})}setRoomId(e){this.roomId=e}async connectedCallback(){if(!this.roomId){let e=a.getState();this.roomId=e.currentGame.shortId}if(!this.roomId){window.goTo("/");return}let e=await this.getGameResult();this.render(e)}async getGameResult(){try{let e=await fetch(`https://ppt-backend-three.vercel.app/api/rooms/${this.roomId}`);if(!e.ok)throw Error(`Error al obtener los resultados del juego: ${e.statusText}`);return await e.json()}catch(e){return console.error("Error al obtener los resultados del juego:",e),alert("Hubo un error al obtener los resultados del juego. Inténtalo de nuevo."),null}}render(t){let o=this.shadow;if(!t)return;let{player1Name:r,player2Name:n,player1Play:s,player2Play:l,statistics:d}=t,p="Es un empate.";if(p=s===l?"Es un empate.":"piedra"===s&&"tijera"===l||"tijera"===s&&"papel"===l||"papel"===s&&"piedra"===l?"¡Ganaste!":"Perdiste.",o){o.innerHTML=`
                <div class="result-container">
                    ...
                    <p>Victorias de ${n}: ${d[n].wins}</p>
                    <p>Derrotas de ${n}: ${d[n].losses}</p>
                    <p>Empates de ${n}: ${d[n].draws}</p>
                    <button class="button" id="play-again-button">Volver a jugar</button>
                </div>
            `;let t=o.querySelector("#play-again-button");t&&t.addEventListener("click",()=>{a.resetGame(),window.goTo("/play")});let c=document.createElement("style");c.textContent=`
                @import url('https://fonts.googleapis.com/css2?family=Odibee+Sans&display=swap');
            ...
            `;let t=this.shadow.querySelector("#new-game-button"),o=this.shadow.querySelector("#join-room-button");t&&t.addEventListener("click",async()=>{let e=await a.createRoom();window.goTo(`/rooms/${e}/join`)}),o&&o.addEventListener("click",()=>{window.goTo("/ingresar-a-sala")})}}}customElements.define("welcome-page",g);class x extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render()}render(){if(this.shadow){this.shadow.innerHTML=`
...
//# sourceMappingURL=index.400232de.js.map
