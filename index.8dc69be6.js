 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n5{constructor(){this.rootNode_=nH.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,t){this.rootNode_=this.rootNode_.updateChild(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rd{constructor(e){this.node_=e}getImmediateChild(e){return new rd(this.node_.getImmediateChild(e))}node(){return this.node_}}class rp{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){let t=np(this.path_,e);return new rp(this.syncTree_,t)}node(){return ri(this.syncTree_,this.path_)}}const rf=function(e,t,n){return e&&"object"==typeof e?(H(".sv"in e,"Unexpected leaf node or priority contents"),"string"==typeof e[".sv"])?r_(e[".sv"],t,n):"object"==typeof e[".sv"]?rm(e[".sv"],t):void H(!1,"Unexpected server value: "+JSON.stringify(e,null,2)):e},r_=function(e,t,n){if("timestamp"===e)return n.timestamp;H(!1,"Unexpected server value: "+e)},rm=function(e,t,n){e.hasOwnProperty("increment")||H(!1,"Unexpected server value: "+JSON.stringify(e,null,2));let i=e.increment;"number"!=typeof i&&H(!1,"Unexpected increment value: "+i);let r=t.node();if(H(null!=r,"Expected ChildrenNode.EMPTY_NODE for nulls"),!r.isLeafNode())return i;let s=r.getValue();return"number"!=typeof s?i:s+i},rg=function(e,t,n,i){return ry(t,new rp(n,e),i)};function ry(e,t,n){let i;let r=rf(e.getPriority().val(),t.getImmediateChild(".priority"),n);if(!e.isLeafNode())return i=e,r!==e.getPriority().val()&&(i=i.updatePriority(new nM(r))),e.forEachChild(nL,(e,r)=>{let s=ry(r,t.getImmediateChild(e),n);s!==r&&(i=i.updateImmediateChild(e,s))}),i;{let i=rf(e.getValue(),t,n);return i!==e.getValue()||r!==e.getPriority().val()?new nM(i,nB(r)):e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rv{constructor(e="",t=null,n={children:{},childCount:0}){this.name=e,this.parent=t,this.node=n}}function rb(e,t){let n=t instanceof ns?t:new ns(t),i=e,r=na(n);for(;null!==r;){let e=em(i.node.children,r)||{children:{},childCount:0};i=new rv(r,i,e),r=na(n=nh(n))}return i}function rC(e){return e.node.value}function rw(e,t){e.node.value=t,function e(t){null!==t.parent&&function(t,n,i){let r=void 0===rC(i)&&!rI(i),s=e_(t.node.children,n);r&&s?(delete t.node.children[n],t.node.childCount--,e(t)):r||s||(t.node.children[n]=i.node,t.node.childCount++,e(t))}(t.parent,t.name,t)}(e)}function rI(e){return e.node.childCount>0}function rE(e,t){tU(e.node.children,(n,i)=>{t(new rv(n,e,i))})}function rT(e){return new ns(null===e.parent?e.name:rT(e.parent)+"/"+e.name)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rS=/[\[\].#$\/\u0000-\u001F\u007F]/,rx=/[\[\].#$\u0000-\u001F\u007F]/,rk=function(e){return"string"==typeof e&&0!==e.length&&!rS.test(e)},rN=function(e){return"string"==typeof e&&0!==e.length&&!rx.test(e)},rP=function(e,t,n){let i=n instanceof ns?new nv(n,e):n;if(void 0===t)throw Error(e+"contains undefined "+nC(i));if("function"==typeof t)throw Error(e+"contains a function "+nC(i)+" with contents = "+t.toString());if(tR(t))throw Error(e+"contains "+t.toString()+" "+nC(i));if("string"==typeof t&&t.length>0xa00000/3&&eE(t)>0xa00000)throw Error(e+"contains a string greater than 10485760 utf8 bytes "+nC(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"==typeof t){let n=!1,r=!1;if(tU(t,(t,s)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(r=!0,!rk(t)))throw Error(e+" contains an invalid key ("+t+") "+nC(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');i.parts_.length>0&&(i.byteLength_+=1),i.parts_.push(t),i.byteLength_+=eE(t),nb(i),rP(e,s,i),function(e){let t=e.parts_.pop();e.byteLength_-=eE(t),e.parts_.length>0&&(e.byteLength_-=1)}(i)}),n&&r)throw Error(e+' contains ".value" child '+nC(i)+" in addition to actual children.")}},rR=function(e,t){let n,i;for(n=0;n<t.length;n++){let r=nu(i=t[n]);for(let t=0;t<r.length;t++)if(".priority"===r[t]&&t===r.length-1);else if(!rk(r[t]))throw Error(e+"contains an invalid key ("+r[t]+") in path "+i.toString()+'. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"')}t.sort(nm);let r=null;for(n=0;n<t.length;n++){if(i=t[n],null!==r&&ny(r,i))throw Error(e+"contains a path "+r.toString()+" that is ancestor of another path "+i.toString());r=i}},rD=function(e,t,n,i){if(i&&void 0===t)return;let r=ew(e,"values");if(!(t&&"object"==typeof t)||Array.isArray(t))throw Error(r+" must be an object containing the children to replace.");let s=[];tU(t,(e,t)=>{let i=new ns(e);if(rP(r,t,np(n,i)),".priority"===nc(i)){if(!(null===t||"string"==typeof t||"number"==typeof t&&!tR(t)||t&&"object"==typeof t&&e_(t,".sv")))throw Error(r+"contains an invalid value for '"+i.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).")}s.push(i)}),rR(r,s)},rA=function(e,t,n,i){if((!i||void 0!==n)&&!rN(n))throw Error(ew(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},rO=function(e,t,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),rA(e,t,n,i)},rM=function(e,t){var n;let i=t.path.toString();if("string"!=typeof t.repoInfo.host||0===t.repoInfo.host.length||!rk(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==i.length&&((n=i)&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),!rN(n)))throw Error(ew(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rL{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function rF(e,t){let n=null;for(let i=0;i<t.length;i++){let r=t[i],s=r.getPath();null===n||ng(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function rq(e,t,n){rF(e,n),rU(e,e=>ng(e,t))}function rj(e,t,n){rF(e,n),rU(e,e=>ny(e,t)||ny(t,e))}function rU(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){let r=e.eventLists_[i];r&&(t(r.path)?(function(e){for(let t=0;t<e.events.length;t++){let n=e.events[t];if(null!==n){e.events[t]=null;let i=n.getEventRunner();tw&&tT("event: "+n.toString()),tB(i)}}}(e.eventLists_[i]),e.eventLists_[i]=null):n=!1)}n&&(e.eventLists_=[]),e.recursionDepth_--}class r${constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new rL,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=n6(),this.transactionQueueTree_=new rv,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function rH(e){var t;return(t=t={timestamp:function(e){let t=e.infoData_.getNode(new ns(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}(e)}).timestamp=t.timestamp||new Date().getTime(),t}function rW(e,t,n,i,r){e.dataUpdateCount++;let s=new ns(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(r){if(i){let t=ey(n,e=>nB(e));o=function(e,t,n,i){let r=rl(e,i);if(!r)return[];{let i=rh(r),s=i.path,o=i.queryId,a=n_(s,t),l=ig.fromObject(n);return rc(e,s,new io(it(o),a,l))}}(e.serverSyncTree_,s,t,r)}else{let t=nB(n);o=rt(e.serverSyncTree_,s,t,r)}}else if(i){let t=ey(n,e=>nB(e));o=function(e,t,n){let i=ig.fromObject(n);return rr(e,new io(ie(),t,i))}(e.serverSyncTree_,s,t)}else{let t=nB(n);o=i7(e.serverSyncTree_,s,t)}let a=s;o.length>0&&(a=rJ(e,s)),rj(e.eventQueue_,a,o)}function rB(e,t){rz(e,"connected",t),!1===t&&function(e){rY(e,"onDisconnectEvents");let t=rH(e),n=n6();n4(e.onDisconnect_,no(),(i,r)=>{let s=rg(i,r,e.serverSyncTree_,t);!function e(t,n,i){if(nf(n))t.value=i,t.children.clear();else if(null!==t.value)t.value=t.value.updateChild(n,i);else{let r=na(n);t.children.has(r)||t.children.set(r,n6()),e(t.children.get(r),n=nh(n),i)}}(n,i,s)});let i=[];n4(n,no(),(t,n)=>{i=i.concat(i7(e.serverSyncTree_,t,n));let r=r1(e,t);rJ(e,r)}),e.onDisconnect_=n6(),rj(e.eventQueue_,no(),i)}(e)}function rz(e,t,n){let i=new ns("/.info/"+t),r=nB(n);e.infoData_.updateSnapshot(i,r);let s=i7(e.infoSyncTree_,i,r);rj(e.eventQueue_,i,s)}function rV(e){return e.nextWriteId_++}function rG(e,t,n){let i;i=".info"===na(t._path)?re(e.infoSyncTree_,t,n):re(e.serverSyncTree_,t,n),rq(e.eventQueue_,t._path,i)}function rY(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),tT(n,...t)}function rK(e,t,n,i){t&&tB(()=>{if("ok"===n)t(null);else{let e=(n||"error").toUpperCase(),r=e;i&&(r+=": "+i);let s=Error(r);s.code=e,t(s)}})}function rQ(e,t,n){return ri(e.serverSyncTree_,t,n)||nH.EMPTY_NODE}function rJ(e,t){let n=rX(e,t),i=rT(n),r=rZ(e,n);return function(e,t,n){if(0===t.length)return;let i=[],r=[],s=t.filter(e=>0===e.status).map(e=>e.currentWriteId);for(let o=0;o<t.length;o++){let a=t[o],l=n_(n,a.path),h=!1,c;if(H(null!==l,"rerunTransactionsUnderNode_: relativePath should not be null."),4===a.status)h=!0,c=a.abortReason,r=r.concat(i9(e.serverSyncTree_,a.currentWriteId,!0));else if(0===a.status){if(a.retryCount>=25)h=!0,c="maxretry",r=r.concat(i9(e.serverSyncTree_,a.currentWriteId,!0));else{let n=rQ(e,a.path,s);a.currentInputSnapshot=n;let i=t[o].update(n.val());if(void 0!==i){rP("transaction failed: Data returned ",i,a.path);let t=nB(i);"object"==typeof i&&null!=i&&e_(i,".priority")||(t=t.updatePriority(n.getPriority()));let o=a.currentWriteId,l=rH(e),h=ry(t,new rd(n),l);a.currentOutputSnapshotRaw=t,a.currentOutputSnapshotResolved=h,a.currentWriteId=rV(e),s.splice(s.indexOf(o),1),r=(r=r.concat(function(e,t,n,i,r){var s,o;return(s=e.pendingWriteTree_,o=r,H(i>s.lastWriteId,"Stacking an older write on top of newer ones"),void 0===o&&(o=!0),s.allWrites.push({path:t,snap:n,writeId:i,visible:o}),o&&(s.visibleWrites=iv(s.visibleWrites,t,n)),s.lastWriteId=i,r)?rr(e,new is(n7(),t,n)):[]}(e.serverSyncTree_,a.path,h,a.currentWriteId,a.applyLocally))).concat(i9(e.serverSyncTree_,o,!0))}else h=!0,c="nodata",r=r.concat(i9(e.serverSyncTree_,a.currentWriteId,!0))}}rj(e.eventQueue_,n,r),r=[],h&&(t[o].status=2,setTimeout(t[o].unwatcher,Math.floor(0)),t[o].onComplete&&("nodata"===c?i.push(()=>t[o].onComplete(null,!1,t[o].currentInputSnapshot)):i.push(()=>t[o].onComplete(Error(c),!1,null))))}r0(e,e.transactionQueueTree_);for(let e=0;e<i.length;e++)tB(i[e]);(function e(t,n=t.transactionQueueTree_){if(n||r0(t,n),rC(n)){let i=rZ(t,n);H(i.length>0,"Sending zero length transaction queue"),i.every(e=>0===e.status)&&function(t,n,i){let r=rQ(t,n,i.map(e=>e.currentWriteId)),s=r,o=r.hash();for(let e=0;e<i.length;e++){let t=i[e];H(0===t.status,"tryToSendTransactionQueue_: items in queue should all be run."),t.status=1,t.retryCount++;let r=n_(n,t.path);s=s.updateChild(r,t.currentOutputSnapshotRaw)}let a=s.val(!0);t.server_.put(n.toString(),a,r=>{rY(t,"transaction put response",{path:n.toString(),status:r});let s=[];if("ok"===r){let r=[];for(let e=0;e<i.length;e++)i[e].status=2,s=s.concat(i9(t.serverSyncTree_,i[e].currentWriteId)),i[e].onComplete&&r.push(()=>i[e].onComplete(null,!0,i[e].currentOutputSnapshotResolved)),i[e].unwatcher();r0(t,rb(t.transactionQueueTree_,n)),e(t,t.transactionQueueTree_),rj(t.eventQueue_,n,s);for(let e=0;e<r.length;e++)tB(r[e])}else{if("datastale"===r)for(let e=0;e<i.length;e++)3===i[e].status?i[e].status=4:i[e].status=0;else{tN("transaction at "+n.toString()+" failed: "+r);for(let e=0;e<i.length;e++)i[e].status=4,i[e].abortReason=r}rJ(t,n)}},o)}(t,rT(n),i)}else rI(n)&&rE(n,n=>{e(t,n)})})(e,e.transactionQueueTree_)}(e,r,i),i}function rX(e,t){let n;let i=e.transactionQueueTree_;for(n=na(t);null!==n&&void 0===rC(i);)i=rb(i,n),n=na(t=nh(t));return i}function rZ(e,t){let n=[];return function e(t,n,i){let r=rC(n);if(r)for(let e=0;e<r.length;e++)i.push(r[e]);rE(n,n=>{e(t,n,i)})}(e,t,n),n.sort((e,t)=>e.order-t.order),n}function r0(e,t){let n=rC(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,rw(t,n.length>0?n:void 0)}rE(t,t=>{r0(e,t)})}function r1(e,t){let n=rT(rX(e,t)),i=rb(e.transactionQueueTree_,t);return!function(e,t,n){let i=e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,t=>{r2(e,t)}),r2(e,i),!function e(t,n,i,r){i&&!r&&n(t),rE(t,t=>{e(t,n,!0,r)}),i&&r&&n(t)}(i,t=>{r2(e,t)}),n}function r2(e,t){let n=rC(t);if(n){let i=[],r=[],s=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(H(s===t-1,"All SENT items should be at beginning of queue."),s=t,n[t].status=3,n[t].abortReason="set"):(H(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(i9(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&i.push(n[t].onComplete.bind(null,Error("set"),!1,null))));-1===s?rw(t,void 0):n.length=s+1,rj(e.eventQueue_,rT(t),r);for(let e=0;e<i.length;e++)tB(i[e])}}const r3=function(e,t){let n=r5(e),i=n.namespace;"firebase.com"===n.domain&&tk(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),i&&"undefined"!==i||"localhost"===n.domain||tk("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||tP();let r="ws"===n.scheme||"wss"===n.scheme;return{repoInfo:new tX(n.host,n.secure,i,r,t,"",i!==n.subdomain),path:new ns(n.pathString)}},r5=function(e){let t="",n="",i="",r="",s="",o=!0,a="https",l=443;if("string"==typeof e){let h=e.indexOf("//");h>=0&&(a=e.substring(0,h-1),e=e.substring(h+2));let c=e.indexOf("/");-1===c&&(c=e.length);let u=e.indexOf("?");-1===u&&(u=e.length),t=e.substring(0,Math.min(c,u)),c<u&&(r=/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r6{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){let e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+eu(this.snapshot.exportVal())}}class r4{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r9{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return nf(this._path)?null:nc(this._path)}get ref(){return new r7(this._repo,this._path)}get _queryIdentifier(){let e=tq(n2(this._queryParams));return"{}"===e?"default":e}get _queryObject(){return n2(this._queryParams)}isEqual(e){if(!((e=eT(e))instanceof r9))return!1;let t=this._repo===e._repo,n=ng(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class r7 extends r9{constructor(e,t){super(e,t,new n0,!1)}get parent(){let e=nd(this._path);return null===e?null:new r7(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class se{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){let t=new ns(e),n=sn(this.ref,e);return new se(this._node.getChild(t),n,nL)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return!this._node.isLeafNode()&&!!this._node.forEachChild(this._index,(t,n)=>e(new se(n,sn(this.ref,t),nL)))}hasChild(e){let t=new ns(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function st(e,t){return(e=eT(e))._checkNotDeleted("ref"),void 0!==t?sn(e._root,t):e._root}function sn(e,t){return null===na((e=eT(e))._path)?rO("child","path",t,!1):rA("child","path",t,!1),new r7(e._repo,np(e._path,t))}function si(e){e=eT(e);let t=new sr(new r8(()=>{}));return(function(e,t,n){let i=function(e,t){var n;let i=t._path,r=null;e.syncPointTree_.foreachOnPath(i,(e,t)=>{let n=n_(e,i);r=r||i2(t,n)});let s=e.syncPointTree_.get(i);s?r=r||i2(s,no()):(s=new iX,e.syncPointTree_=e.syncPointTree_.set(i,s));let o=null!=r,a=o?new ia(r,!0,!1):null,l=(n=e.pendingWriteTree_,iF(t._path,n));return ip(i0(s,t,l,o?a.getNode():nH.EMPTY_NODE,o).viewCache_)}(e.serverSyncTree_,t);return null!=i?Promise.resolve(i):e.server_.get(t).then(i=>{let r;let s=nB(i).withIndex(t._queryParams.getIndex());if(rn(e.serverSyncTree_,t,n,!0),t._queryParams.loadsAllData())r=i7(e.serverSyncTree_,t._path,s);else{let n=ro(e.serverSyncTree_,t);r=rt(e.serverSyncTree_,t._path,s,n)}return rj(e.eventQueue_,t._path,r),re(e.serverSyncTree_,t,n,null,!0),s},n=>(rY(e,"get for query "+eu(t)+" failed: "+n),Promise.reject(Error(n))))})(e._repo,e,t).then(t=>new se(t,new r7(e._repo,e._path),e._queryParams.getIndex()))}class sr{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){let n=t._queryParams.getIndex();return new r6("value",this,new se(e.snapshotNode,new r7(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new r4(this,e,t):null}matches(e){return e instanceof sr&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class ss{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new r4(this,e,t):null}createEvent(e,t){H(null!=e.childName,"Child events should have a childName.");let n=sn(new r7(t._repo,t._path),e.childName),i=t._queryParams.getIndex();return new r6(e.type,this,new se(e.snapshotNode,n,i),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof ss&&this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext))}hasAnyCallback(){return!!this.callbackContext}}function so(e,t,n,i){return function(e,t,n,i,r){var s;let o,a;if("object"==typeof i&&(o=void 0,r=i),"function"==typeof i&&(o=i),r&&r.onlyOnce){let t=n,i=(n,i)=>{rG(e._repo,e,h),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}let l=new r8(n,o||void 0),h="value"===t?new sr(l):new ss(t,l);return s=e._repo,a=".info"===na(e._path)?rn(s.infoSyncTree_,e,h):rn(s.serverSyncTree_,e,h),rq(s.eventQueue_,e._path,a),()=>rG(e._repo,e,h)}(e,"value",t,n,i)}H(!c,"__referenceConstructor has already been defined"),c=r7,H(!u,"__referenceConstructor has already been defined"),u=r7;const sa={};class sl{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(function(e,t,n){if(e.stats_=t3(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new n3(e.repoInfo_,(t,n,i,r)=>{rW(e,t,n,i,r)},e.authTokenProvider_,e.appCheckProvider_),setTimeout(()=>rB(e,!0),0);else{if(null!=n){if("object"!=typeof n)throw Error("Only objects are supported for option databaseAuthVariableOverride");try{eu(n)}catch(e){throw Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new nI(e.repoInfo_,t,(t,n,i,r)=>{rW(e,t,n,i,r)},t=>{rB(e,t)},t=>{var n;n=e,tU(t,(e,t)=>{rz(n,e,t)})},e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener(t=>{e.server_.refreshAuthToken(t)}),e.appCheckProvider_.addTokenChangeListener(t=>{e.server_.refreshAppCheckToken(t.token)}),e.statsReporter_=function(e,t){let n=e.toString();return t2[n]||(t2[n]=t()),t2[n]}(e.repoInfo_,()=>new n9(e.stats_,e.server_)),e.infoData_=new n5,e.infoSyncTree_=new i8({startListening:(t,n,i,r)=>{let s=[],o=e.infoData_.getNode(t._path);return o.isEmpty()||(s=i7(e.infoSyncTree_,t._path,o),setTimeout(()=>{r("ok")},0)),s},stopListening:()=>{}}),rz(e,"connected",!1),e.serverSyncTree_=new i8({startListening:(t,n,i,r)=>(e.server_.listen(t,i,n,(n,i)=>{let s=r(n,i);rj(e.eventQueue_,t._path,s)}),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new r7(this._repo,no())),this._rootInternal}_delete(){return null!==this._rootInternal&&(function(e,t){let n=sa[t];n&&n[e.key]===e||tk(`Database ${t}(${e.repoInfo_}) has already been deleted.`),e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt"),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&tk("Cannot call "+e+" on a deleted database.")}}function sh(e=function(e=eZ){let t=e1.get(e);if(!t&&e===eZ&&ei())return e9();if(!t)throw e4.create("no-app",{appName:e});return t}(),t){let n=(function(e,t){let n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)})(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){let e=en("database");e&&function(e,t,n,i={}){var r;let s;(e=eT(e))._checkNotDeleted("useEmulator");let o=`${t}:${n}`,a=e._repoInternal;if(e._instanceStarted){if(o===e._repoInternal.repoInfo_.host&&ev(i,a.repoInfo_.emulatorOptions))return;tk("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}a.repoInfo_.nodeAdmin?(i.mockUserToken&&tk('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),s=new tY(tY.OWNER)):i.mockUserToken&&(s=new tY("string"==typeof i.mockUserToken?i.mockUserToken:function(e,t){if(e.uid)throw Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');let n=t||"demo-project",i=e.iat||0,r=e.sub||e.user_id;if(!r)throw Error("mockUserToken must contain 'sub' or 'user_id' field!");let s=Object.assign({iss:`https://securetoken.google.com/${n}`,aud:n,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},e);return[K(JSON.stringify({alg:"none",type:"JWT"})),K(JSON.stringify(s)),""].join(".")}(i.mockUserToken,e.app.options.projectId))),r=s,a.repoInfo_=new tX(o,!1,a.repoInfo_.namespace,a.repoInfo_.webSocketOnly,a.repoInfo_.nodeAdmin,a.repoInfo_.persistenceKey,a.repoInfo_.includeNamespaceInQueryParams,!0,i),r&&(a.authTokenProvider_=r)}(n,...e)}return n}nI.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},nI.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)},td="11.4.0",e6(new eS("database",(e,{instanceIdentifier:t})=>{let n=e.getProvider("app").getImmediate();return function(e,t,n,i,r){var s,o,a,l;let h,c,u,d,p=i||e.options.databaseURL;void 0===p&&(e.options.projectId||tk("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),tT("Using default host for project ",e.options.projectId),p=`${e.options.projectId}-default-rtdb.firebaseio.com`);let f=r3(p,void 0),_=f.repoInfo;void 0!==N&&N.env&&(u=N.env.FIREBASE_DATABASE_EMULATOR_HOST),u?(d=!0,_=(f=r3(p=`http://${u}?ns=${_.namespace}`,void 0)).repoInfo):d=!f.repoInfo.secure;let m=r&&d?new tY(tY.OWNER):new tG(e.name,e.options,t);return rM("Invalid Firebase Database URL",f),nf(f.path)||tk("Database URL must point to the root of a Firebase Database (not including a child path)."),new sl((s=_,o=e,a=m,l=new tV(e,n),(h=sa[o.name])||(h={},sa[o.name]=h),(c=h[s.toURLString()])&&tk("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),c=new r$(s,!1,a,l),h[s.toURLString()]=c,c),e)}(n,e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)},"PUBLIC").setMultipleInstances(!0)),e7(tc,tu,void 0),e7(tc,tu,"esm2017"),/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */e7("firebase","11.4.0","app");const sc=sh(e9({apiKey:"AIzaSyBqoATuWSOg3ZDbSBOsvLiww1xc5xLSxak",authDomain:"desafio-ppt-e6f00.firebaseapp.com",databaseURL:"https://desafio-ppt-e6f00-default-rtdb.firebaseio.com",projectId:"desafio-ppt-e6f00",storageBucket:"desafio-ppt-e6f00.firebasestorage.app",messagingSenderId:"1005620596792",appId:"1:1005620596792:web:186bd21929786d9e1f16cd",measurementId:"G-QYCNTVFR3L"})),su={player1Name:null,player2Name:null,roomId:"",currentGame:null,playerNumber:void 0,id:null,rtdbRoomId:"",setCurrentGame:e=>{su.currentGame=e},player1Id:null,player2Id:null},sd=[],sp={getState:()=>(su.currentGame||(su.currentGame={roomId:su.roomId||"",data:{player1Name:null,player2Name:null,player1Play:null,player2Play:null,gameOver:!1},statistics:{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}),su),setState(e){let t={...su,...e};for(let e of(Object.assign(su,t),sd))e(su);console.log("State actualizado:",su)},subscribe:e=>(sd.push(e),()=>{let t=sd.indexOf(e);-1!==t&&sd.splice(t,1)}),async getRoomData(e){try{console.log("getRoomData buscando roomId:",e);let t=st(sc,`rooms/${e}/games/current`),n=(await si(t)).val();if(n)return n;return console.error("state.ts:85 No se encontraron datos de la sala (games/current)."),null}catch(e){return console.error("Error al obtener datos de la sala:",e),null}},listenRoom(){if(!su.roomId){console.error("No hay roomId para escuchar.");return}so(st(sc,`rooms/${su.roomId}/games/current`),e=>{let t=e.val();if(console.log("Datos recibidos de la base de datos (games/current):",t),t){let e=su.player1Name,n=su.player2Name;sp.setState({...su,currentGame:{roomId:su.roomId,data:{player1Name:e,player2Name:n,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver},statistics:su.currentGame?.statistics||{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}}}),console.log("Estado del juego actualizado:",su.currentGame)}else console.error("Datos de la partida actual incompletos o nulos en games/current:",t)},e=>{console.error("Error al escuchar la sala (games/current):",e)}),so(st(sc,`rooms/${su.roomId}/users`),e=>{let t=e.val();if(t){let e=Object.values(t),n=[];if(e.forEach(e=>{"object"==typeof e&&null!==e&&"userName"in e&&"role"in e&&"id"in e?n.push({userName:e.userName,role:e.role,id:e.id}):console.warn("Datos de usuario con estructura inesperada:",e)}),1===n.length){let e=n[0];sp.setPlayer1Name(e.userName,e.id),sp.setPlayer2Name(null,null),sp.setPlayerNumber(su.id===e.id?1:void 0)}else if(2===n.length){let e=n.find(e=>"owner"===e.role),t=n.find(e=>"guest"===e.role);e&&t&&(sp.setPlayer1Name(e.userName,e.id),sp.setPlayer2Name(t.userName,t.id),sp.setPlayerNumber(su.id===e.id?1:su.id===t.id?2:void 0))}else sp.setPlayer1Name(null,null),sp.setPlayer2Name(null,null),sp.setPlayerNumber(void 0);console.log("Estado actualizado con users:",su)}else console.log("No hay usuarios en la sala."),sp.setPlayer1Name(null,null),sp.setPlayer2Name(null,null),sp.setPlayerNumber(void 0)})},async setMove(e){let t=sp.getState(),n=t.roomId,i=t.playerNumber;if(!n){console.error("No se encontró el roomId");return}try{let t=st(sc,`rooms/${n}/games/current`);await function(e,t){rD("update",t,e._path,!1);let n=new er;return function(e,t,n,i){rY(e,"update",{path:t.toString(),value:n});let r=!0,s=rH(e),o={};if(tU(n,(n,i)=>{r=!1,o[n]=rg(np(t,n),nB(i),e.serverSyncTree_,s)}),r)tT("update() called with empty data.  Don't do anything."),rK(e,i,"ok",void 0);else{let r=rV(e),s=function(e,t,n,i){var r;r=e.pendingWriteTree_,H(i>r.lastWriteId,"Stacking an older merge on top of newer ones"),r.allWrites.push({path:t,children:n,writeId:i,visible:!0}),r.visibleWrites=ib(r.visibleWrites,t,n),r.lastWriteId=i;let s=ig.fromObject(n);return rr(e,new io(n7(),t,s))}(e.serverSyncTree_,t,o,r);rF(e.eventQueue_,s),e.server_.merge(t.toString(),n,(n,s)=>{let o="ok"===n;o||tN("update at "+t+" failed: "+n);let a=i9(e.serverSyncTree_,r,!o),l=a.length>0?rJ(e,t):t;rj(e.eventQueue_,l,a),rK(e,i,n,s)}),tU(n,n=>{let i=r1(e,np(t,n));rJ(e,i)}),rj(e.eventQueue_,t,[])}}(e._repo,e._path,t,n.wrapCallback(()=>{})),n.promise}(t,1===i?{player1Move:e}:{player2Move:e}),console.log("Movimiento enviado con éxito")}catch(e){console.error("Error al enviar el movimiento:",e)}},setId:e=>{sp.setState({id:e})},setPlayer1Name:(e,t)=>{sp.setState({player1Name:e,player1Id:t})},setPlayer2Name:(e,t)=>{sp.setState({player2Name:e,player2Id:t})},setPlayerNumber:e=>{sp.setState({playerNumber:e})},setRoomId:e=>{sp.setState({roomId:e})},saveRoomData:async(e,t,n,i,r)=>{try{let s=await fetch("https://ppt-backend-1.onrender.com/api/guardardatos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({ownerId:e,ownerName:t,guestId:n,guestName:i,roomId:r})});if(!s.ok)return console.error("Error al guardar datos en el backend:",s.status),null;return await s.json()}catch(e){return console.error("Error de red al guardar datos:",e),null}}};class sf extends HTMLElement{constructor(){super(),this.unsubscribe=null,this.roomId=null,this.loading=!0,this.shadow=this.attachShadow({mode:"open"})}async connectedCallback(){try{let e=sp.getState().currentGame?.roomId;if(console.log("ShortId connectedCallback - roomId from state:",e),!e){if(console.warn("ShortId connectedCallback - roomId no encontrado en el estado. Intentando obtenerlo del URL..."),e=window.location.pathname.split("/")[2],console.log("ShortId connectedCallback - roomId from URL (window.location):",e),e)sp.setRoomId(e);else{console.error("ShortId connectedCallback - No se pudo obtener roomId."),this.loading=!1,this.render();return}}if(su.roomId){let e=await this.getRoomData(su.roomId);console.log("ShortId connectedCallback - roomData:",e);let t={roomId:su.roomId,data:e||{player1Name:null,player2Name:null},statistics:e?.statistics||{player1:{wins:0,losses:0,draws:0},player2:{wins:0,losses:0,draws:0}}};sp.setState({currentGame:{...sp.getState().currentGame,...t}})}else{console.error("ShortId connectedCallback - state.roomId no está definido antes de getRoomData."),this.loading=!1,this.render();return}this.loading=!1,this.render(),this.listenRoomChanges()}catch(e){console.error("ShortId connectedCallback - Error:",e),this.loading=!1,this.render()}}async getRoomData(e){if(!e)return console.error("ShortId getRoomData - No se proporcionó roomId."),null;let t=st(sc,`rooms/${e}`);try{let e=(await si(t)).val();return console.log("ShortId getRoomData - Datos obtenidos:",e),e}catch(e){return console.error("ShortId getRoomData - Error al obtener datos:",e),null}}disconnectedCallback(){this.unsubscribeFromState(),this.stopListeningRoomChanges()}listenRoomChanges(){if(!su.roomId){console.error("ShortId listenRoomChanges - No hay roomId para escuchar.");return}so(st(sc,`rooms/${su.roomId}`),e=>{let t=e.val();if(console.log("ShortId listenRoomChanges - Datos recibidos de la base de datos:",t),t&&t.users){let e=Object.values(t.users);if(1===e.length){let n=e[0];sp.setPlayer1Name(n.userName,n.id),sp.setPlayer2Name(null,n.id),sp.setState({...su,currentGame:{...su.currentGame,roomId:su.roomId,data:{...su.currentGame?.data,player1Name:n.userName,player2Name:null,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver}}})}else if(2===e.length){let n=e[0],i=e[1];sp.setPlayer1Name(n.userName,n.id),sp.setPlayer2Name(i.userName,i.id),sp.setState({...su,currentGame:{...su.currentGame,roomId:su.roomId,data:{...su.currentGame?.data,player1Name:n.userName,player2Name:i.userName,player1Play:t.player1Move,player2Play:t.player2Move,gameOver:t.gameOver}}})}console.log("ShortId listenRoomChanges - Estado actualizado con users:",su),this.render()}else console.warn("ShortId listenRoomChanges - Datos de sala incompletos o nulos:",t)},e=>{console.error("ShortId listenRoomChanges - Error al escuchar la sala:",e)})}stopListeningRoomChanges(){this.roomId}subscribeToState(){this.unsubscribe=sp.subscribe(()=>{this.render()})}unsubscribeFromState(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null)}render(){let e=sp.getState(),t=e.currentGame,n="Esperando Jugador 1",i="Esperando Jugador 2",r=e.player1Name,s=e.player2Name||"Esperando Jugador 2",o=e.roomId;t&&t.data&&(n=t.data.player1Name||"Esperando Jugador 1",i=t.data.player2Name||"Esperando Jugador 2"),this.shadow.innerHTML=`
            <style>
                .container {
        ...
        `;let a=this.shadow.getElementById("instructions-button");a&&a.addEventListener("click",()=>{sP.goTo("/instructions")})}determinePlayerNumber(e){return 1}}customElements.define("short-id-page",sf);class s_ extends HTMLElement{constructor(){super(),this.unsubscribe=null,this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.subscribeToState()}disconnectedCallback(){this.unsubscribeFromState()}subscribeToState(){this.unsubscribe=sp.subscribe(()=>{this.render()})}unsubscribeFromState(){this.unsubscribe&&(this.unsubscribe(),this.unsubscribe=null)}render(){let e=sp.getState();this.shadow.innerHTML=`
      <style>
        .container {
          background-image: url(${_(x)});
          background-size: cover;
    ...
    `;let t=this.shadow.querySelector(".play-button");t&&t.addEventListener("click",()=>{sP.goTo("/play")})}}customElements.define("instructions-page",s_);var sm={};sm=new URL("piedra.2b6b2e59.png",import.meta.url).toString();var sg={};sg=new URL("tijera.4b8c96df.png",import.meta.url).toString();var sy={};sy=new URL("papel.7c3d639f.png",import.meta.url).toString();class sv extends HTMLElement{constructor(){super(),this.roomId=null,this.playerNumber=1,this.unsubscribe=null,this.myMove=null,this.opponentMove=null,this.timerInterval=null,this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.subscribeToState()}disconnectedCallback(){this.unsubscribe&&this.unsubscribe()}subscribeToState(){this.unsubscribe=sp.subscribe(()=>{console.log("El estado ha cambiado, actualizando UI..."),this.updateUI()})}render(){let e=this.shadow;if(e){e.innerHTML=`
                <div class="play-container">
                    ...
                    <div class="moves">
                        <button id="piedra"><img src="${_(sm)}" alt="piedra"/></button>
                        <button id="papel"><img src="${_(sy)}" alt ="papel"/></button>
                        <button id="tijera"><img src="${_(sg)}" alt="Tijera"/></button>
                    </div>
                    <div>
        ...
        `,this.appendChild(i)}}customElements.define("tu-nombre",sE);class sT extends HTMLElement{constructor(){super(),this.render()}render(){let e=sp.getState().currentGame;if(!e||!e.data){this.innerHTML=`
        ...
        `,this.appendChild(a)}}customElements.define("result-page",sT);class sS extends HTMLElement{constructor(){super(),this.render()}render(){this.innerHTML=`
      <div class="welcome-container">
    ...
    `,this.appendChild(e),this.addEventListeners()}addEventListeners(){let e=this.querySelector(".new-game-button"),t=this.querySelector(".join-room-button");e&&e.addEventListener("click",()=>{sP.goTo("/tu-nombre")}),t&&t.addEventListener("click",()=>{sP.goTo("/ingresar-a-sala")})}}customElements.define("welcome-page",sS);class sx extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){let e=document.createElement("style");e.textContent=`
            .join-room-container {
                background-image: url(${_(x)});
                background-size: cover;
                background-repeat: no-repeat;
        ...
        `,this.shadow.appendChild(e);let t=document.createElement("div");t.classList.add("join-room-container");let n=document.createElement("h2");n.textContent="Ingresar a una Sala",t.appendChild(n);let i=document.createElement("div");i.classList.add("form-group");let r=document.createElement("input");r.setAttribute("type","text"),r.setAttribute("placeholder","Código para ingresar a la sala"),r.id="roomIdInput",i.appendChild(r),t.appendChild(i);let s=document.createElement("div");s.classList.add("form-group");let o=document.createElement("input");o.setAttribute("type","text"),o.setAttribute("placeholder","Tu nombre"),o.id="nombreInput",s.appendChild(o),t.appendChild(s);let a=document.createElement("button");a.textContent="Unirse a Sala",a.id="unirseButton",t.appendChild(a),this.shadow.appendChild(t);let l=this.shadow.getElementById("unirseButton"),h=this.shadow.getElementById("roomIdInput"),c=this.shadow.getElementById("nombreInput");l&&h&&c&&l.addEventListener("click",async()=>{let e=c.value,t=h.value,n=su.id||Math.random().toString(36).substring(2,15);sp.setPlayer2Name(e,n),sp.setRoomId(t),await sp.saveRoomData(null,null,n,e,t),setTimeout(()=>{sp.listenRoom(),sP.goTo(`/short-id/${t}`)},100)})}render(){}}customElements.define("ingresar-a-sala",sx);const sk=[{pathRegex:/^\/$/,render:()=>new sS},{pathRegex:/^\/instructions$/,render:()=>new s_},{pathRegex:/^\/play$/,render:()=>new sv},{pathRegex:/^\/result$/,render:()=>new sT},{pathRegex:/^\/tu-nombre$/,render:()=>new sE},{pathRegex:/^\/short-id\/(?<roomId>[a-zA-Z0-9]+)$/,render:e=>(e?.roomId,new sf)},{pathRegex:/^\/ingresar-a-sala$/,render:()=>new sx}];function sN(e){let t=sk.find(t=>t.pathRegex.test(e));if(t){let n=document.getElementById("app");if(n){n.innerHTML="";let i=e.match(t.pathRegex),r=i?.groups||{},s=t.render(r);s instanceof Promise?s.then(e=>{n.appendChild(e)}).catch(e=>{console.error("Error al renderizar la ruta:",e)}):n.appendChild(s)}else console.warn("Elemento #app no encontrado.")}else console.warn(`Ruta no encontrada: ${e}`)}const sP={goTo:async e=>{window.history.pushState({},"",e),await sN(e)}};!function(){let e=function(){let e=window.location.pathname,t="/PPT-FRONTEND";return e.startsWith(t)?e.replace(t,"")||"/":e}();console.log("Ruta inicial:",e),sN(e)}();
//# sourceMappingURL=index.8dc69be6.js.map
